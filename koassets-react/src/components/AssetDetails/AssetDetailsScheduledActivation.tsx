                ...
                <div className="asset-details-content">
                    <div className="asset-details-grid">
                        <div className="asset-details-group">
                            <h4 className="assets-details-metadata-label">On Time</h4>
                            <span className="assets-details-metadata-value">{selectedImage?.onTime as string}</span>
                        </div>

                        <div className="asset-details-group">
                            <h4 className="assets-details-metadata-label">Off Time</h4>
                            <span className="assets-details-metadata-value">{selectedImage?.offTime as string}</span>
                        </div>
                    </div>
                </div>
            )}
